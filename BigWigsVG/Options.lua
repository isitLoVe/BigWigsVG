...
function BigWigsOptions:OnClick()
	if BigWigs:IsActive() then
		if IsAltKeyDown() then
			...
			BigWigsOnScreenIcons:Nothstop()
			BigWigsOnScreenIcons:Geddonstop()
			BigWigsOnScreenIcons:Runstop()
			BigWigsOnScreenIcons:Hakkarstop()
			BigWigsOnScreenIcons:Shieldstop()
			BigWigsOnScreenIcons:Cthunglarestop()
			BigWigsOnScreenIcons:Cthuneyesstop()
			BigWigsOnScreenIcons:Cthungeyesstop()
			BigWigsOnScreenIcons:Cthungclawstop()
			BigWigsOnScreenIcons:Sporestop()
